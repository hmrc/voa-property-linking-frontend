...
class ClaimPropertyOwnershipSpec extends VoaPropertyLinkingSpec {
  ...
  "The claim ownership page" should "contain the claim property form" in {
    StubSubmissionIdConnector.stubId(submissionId)
    withLinkingSession.stubSession(arbitraryLinkinSession.arbitrary.sample.get, detailedIndividualAccount, groupAccount(false))
  ...
  "The claim ownership page on client behalf" should "contain the claim property form" in {
    StubSubmissionIdConnector.stubId(submissionId)
    withLinkingSession.stubSession(arbitraryLinkinSession.arbitrary.sample.get, detailedIndividualAccount, groupAccount(false))
