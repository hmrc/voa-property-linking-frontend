...
import org.scalatest.{AppendedClues, AsyncFlatSpec, BeforeAndAfterEach, MustMatchers}
import play.api.test.DefaultAwaitTimeout
import utils._

trait AsyncControllerSpec extends AsyncFlatSpec with MustMatchers with DefaultAwaitTimeout with BeforeAndAfterEach with AppendedClues {
