...
package object resources {
  ...
  } yield models.ClientProperty(ownerOrganisationId, ownerOrganisationName, billingAuthorityReference, authorisedPartyId, permissionId, checkPermission, challengePermission, address)
