...
package object resources {
  ...
  } yield models.ClientProperty(ownerOrganisationId, ownerOrganisationName, billingAuthorityReference, permissionId, checkPermission, challengePermission, address)
