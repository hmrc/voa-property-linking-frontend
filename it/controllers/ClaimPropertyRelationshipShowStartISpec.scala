...
class ClaimPropertyRelationshipShowStartISpec extends ISpecBase with HtmlComponentHelpers with ListYearsHelpers {
  ...
  val youllNeedText = "You’ll need to prove your connection to the property with evidence such as a business rates bill or lease. The date of the evidence must overlap with the period you owned or occupied the property. See how we will use the information you provide."
  val clientYoullNeedText = "You’ll need to prove your client’s connection to the property with evidence such as a business rates bill or lease. The date of the evidence must overlap with the period your client owned or occupied the property. See how we will use the information you provide."
  val howWeText = "how we will use the information you provide"
  val weAimText = "We aim to give you a decision on your request to add a property as quickly as possible, but it may take up to 15 working days."
  ...
  val youllNeedTextWelsh = "Bydd angen i chi brofi’ch cysylltiad â’r eiddo drwy ddarparu tystiolaeth megis bil ardrethi busnes neu brydles. Rhaid i ddyddiad y dystiolaeth orgyffwrdd â’r cyfnod yr oeddech yn berchen neu’n meddiannu’r eiddo. Ewch i sut rydym yn defnyddio’r wybodaeth rydych yn ei darparu."
  val clientYoullNeedTextWelsh = "Bydd angen i chi brofi cysylltiad eich cleient â’r eiddo drwy ddarparu tystiolaeth megis bil ardrethi busnes neu brydles. Rhaid i ddyddiad y dystiolaeth orgyffwrdd â’r cyfnod roedd eich cleient yn berchen neu’n meddiannu’r eiddo. Ewch i sut rydym yn defnyddio’r wybodaeth rydych yn ei darparu."
  val howWeTextWelsh = "sut rydym yn defnyddio’r wybodaeth rydych yn ei darparu"
  val weAimTextWelsh = "Ein nod yw rhoi penderfyniad i chi ar eich cais i ychwanegu eiddo cyn gynted â phosibl, ond gall gymryd hyd at 15 diwrnod gwaith."
  ...
  private def getShowStartPage(language: Language, isAgent: Boolean): Document = {
    ...
    val ipUrl = s"http://localhost:$port/business-rates-property-linking/my-organisation/claim/property-links/capacity/2198480000?rtp=summary-valuation&valuationId=10007980"
    val agentUrl = s"http://localhost:$port/business-rates-property-linking/my-organisation/claim/property-links/capacity/2198480000?rtp=summary-valuation&valuationId=10007980&organisationId=1234&organisationName=Test"
