...
class RegisterAssistantISpec extends ISpecBase with HtmlComponentHelpers with ListYearsHelpers {
  ...
  private def stubsSetup: StubMapping = {
    ...
    val authResponseBody = """{ "affinityGroup": "Organisation", "credentialRole": "Assistant", "optionalName": {"name": "Test First Name", "lastName": "Test Last Name"}, "email": "test@test.com", "groupIdentifier": "1", "externalId": "3", "confidenceLevel": 200}"""
