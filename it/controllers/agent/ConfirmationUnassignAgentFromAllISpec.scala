...
class ConfirmationUnassignAgentFromAllISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val titleMultiplePropertiesText = "Test Agent has been unassigned from all your properties - Valuation Office Agency - GOV.UK"
  ...
  val paragraphTwoText = "The agent has not been removed from your account. They can still act for you if they add other properties to your account."
  ...
  val titleMultiplePropertiesTextWelsh = "Mae Test Agent wedi’i ddadneilltuo o’ch holl eiddo - Valuation Office Agency - GOV.UK"
  ...
  val paragraphTwoTextWelsh = "Nid yw’r asiant wedi’i dynnu o’ch cyfrif. Gallant barhau i weithredu ar eich rhan os ydynt yn ychwanegu eiddo eraill at eich cyfrif."
