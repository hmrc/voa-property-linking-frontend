...
class AreYouSureMultipleISpec extends ISpecBase with HtmlComponentHelpers with ListYearsHelpers {
  ...
  val titleTextWelsh = "A ydych yn siŵr eich bod am i Test Agent weithredu ar restrau ardrethu 2023 a 2017 ar eich rhan? - Valuation Office Agency - GOV.UK"
  val backLinkTextWelsh = "Yn ôl"
  val captionTextWelsh = "Rheoli asiant"
  val headerTextWelsh = "A ydych yn siŵr eich bod am i Test Agent weithredu ar restrau ardrethu 2023 a 2017 ar eich rhan?"
  val forAllTextWelsh = "Bydd yr asiant hwn yn gallu gwneud y canlynol ar gyfer pob un o’ch prisiadau eiddo o restrau ardrethu 2023 a 2017:"
  ...
  val thisAppliesTextWelsh = "Mae hyn yn berthnasol i eiddo rydych yn eu neilltuo iddo, ac i eiddo y mae’n eu hychwanegu at eich cyfrif"
