...
class RatingListConfirmedISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val titleTextWelsh = "Mae’r rhestrau ardrethu y gall Test Agent weithredu arnynt ar eich rhan wedi newid - Valuation Office Agency - GOV.UK"
  val headerTextWelsh = "Mae’r rhestrau ardrethu y gall Test Agent weithredu arnynt ar eich rhan wedi newid"
  def thisAgentTextSingleWelsh(listYear: String) = s"Gall yr asiant hwn weithredu ar eich rhan ar brisiadau eich eiddo o restr ardrethu $listYear, ar gyfer eiddo rydych yn eu neilltuo iddo, ac ar gyfer eiddo y mae’n eu hychwanegu at eich cyfrif"
  val thisAgentTextMultipleWelsh = "Gall yr asiant hwn weithredu ar eich rhan ar brisiadau eich eiddo o restrau ardrethu 2023 a 2017, ar gyfer eiddo rydych yn eu neilltuo iddo, ac ar gyfer eiddo y mae’n eu hychwanegu at eich cyfrif"
  val whatHappensTextWelsh = "Yr hyn sy’n digwydd nesaf"
  val youCanTextWelsh = "Gallwch newid pa restrau ardrethu y gall yr asiant hwn weithredu arnynt ar eich rhan ar unrhyw adeg."
