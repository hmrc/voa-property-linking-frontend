...
class ClaimPropertyOwnershipISpec extends ISpecBase with HtmlComponentHelpers with ListYearsHelpers {
  ...
  val occupancyEndDate: Option[PropertyOccupancy] = Some(PropertyOccupancy(stillOccupied = false, lastOccupiedDate = Some(LocalDate.of(2021, 1, 1))))
  ...
  val futureDateErrorOwnerOccupierAgentText = "Date your client became owner and occupier of the property must be in the past"

  val dateBeforeErrorOwnerText = "Date you became the owner of the property must be before 1 January 2021"
  val dateBeforeErrorOwnerOccupierText = "Date you became the owner and occupier of the property must be before 1 January 2021"
  ...
  val dateBeforeErrorOwnerOccupierAgentText = "Date your client became the owner and occupier of the property must be before 1 January 2021"
  val dateBeforeErrorOccupierAgentText = "Date your client became the occupier of the property must be before 1 January 2021"
  ...
  val futureDateErrorOwnerOccupierTextWelsh = "Rhaid i’r dyddiad y daethoch yn owner ac occupier yr eiddo fod yn y gorffennol"
  val futureDateErrorOwnerAgentTextWelsh = "Rhaid i’r dyddiad y daeth eich cleient yn owner yr eiddo fod yn y gorffennol"
  val futureDateErrorOccupierAgentTextWelsh = "Rhaid i’r dyddiad y daeth eich cleient yn occupier yr eiddo fod yn y gorffennol"
  val futureDateErrorOwnerOccupierAgentTextWelsh = "Rhaid i’r dyddiad y daeth eich cleient yn owner ac occupier yr eiddo fod yn y gorffennol"
  ...
  val dateBeforeErrorOwnerOccupierTextWelsh = "Rhaid i’r dyddiad y daethoch yn owner ac occupier yr eiddo fod cyn 1 Ionawr 2021"
  val dateBeforeErrorOwnerAgentTextWelsh = "Rhaid i’r dyddiad y daeth eich cleient yn owner yr eiddo fod cyn 1 Ionawr 2021"
  val dateBeforeErrorOccupierAgentTextWelsh = "Rhaid i’r dyddiad y daeth eich cleient yn occupier yr eiddo fod cyn 1 Ionawr 2021"
  val dateBeforeErrorOwnerOccupierAgentTextWelsh = "Rhaid i’r dyddiad y daeth eich cleient yn owner ac occupier yr eiddo fod cyn 1 Ionawr 2021"

  val emptyInputErrorTextWelsh = "Ar ba ddyddiad ddaethoch chi’n berchennog neu’r meddiannydd? - Nodwch ddyddiad dilys"
  val emptyInputErrorAgentTextWelsh = "Ar ba ddyddiad y daeth eich cleient yn berchennog neu’n feddiannydd? - Nodwch ddyddiad dilys"
  ...
  "ClaimPropertyOwnershipController submitOwnership method" should {
    "Redirect to the occupancy page when they enter a valid date" in {
      ...
      val res = submitOwnership(day = "01", month = "01", year = "2020", userIsAgent = true, fromCya = false, relationship = "owner")
    ...
    "Return a bad request with errors for an agent of an owner when the date is in the future" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "01", year = "2999", userIsAgent = true, relationship = "owner")
    ...
    "Return a bad request with errors for an agent of an occupier when the date is in the future" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "01", year = "2999", userIsAgent = true, relationship = "occupier")
    ...
    "Return a bad request with errors for a user who's an owner when the date is after the end date" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "02", year = "2021", relationship = "owner", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for a user who's an occupier when the date is after the end date" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "02", year = "2021", relationship = "occupier", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for a user who's an owner and occupier when the date is after the end date" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "02", year = "2021", relationship = "both", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent of an owner when the date is after the end date" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "02", year = "2021", userIsAgent = true, relationship = "owner", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent of an occupier when the date is after the end date" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "02", year = "2021", userIsAgent = true, relationship = "occupier", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent of an owner and occupier when the date is after the end date" which {
      ...
      lazy val res = submitOwnership(day = "01", month = "02", year = "2021", userIsAgent = true, relationship = "both", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent when no data is entered for the day/month/year in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "", month = "", year = "", relationship = "owner", userIsAgent = true)
    ...
    "Return a bad request with errors for a user who's an occupier when the date is in the future in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "01", year = "2999", relationship = "occupier")
    ...
    "Return a bad request with errors for an agent of an owner when the date is in the future in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "01", year = "2999", userIsAgent = true, relationship = "owner")
    ...
    "Return a bad request with errors for an agent of an occupier when the date is in the future in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "01", year = "2999", userIsAgent = true, relationship = "occupier")
    ...
    "Return a bad request with errors for an agent of an owner and occupier when the date is in the future in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "01", year = "2999", userIsAgent = true, relationship = "both")
    ...
    "Return a bad request with errors for a user who's an owner when the date is after the end date in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "02", year = "2021", relationship = "owner", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for a user who's an occupier when the date is after the end date in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "02", year = "2021", relationship = "occupier", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for a user who's an owner and occupier when the date is after the end date in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "02", year = "2021", relationship = "both", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent of an owner when the date is after the end date in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "02", year = "2021", userIsAgent = true, relationship = "owner", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent of an occupier when the date is after the end date in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "02", year = "2021", userIsAgent = true, relationship = "occupier", endDate = occupancyEndDate)
    ...
    "Return a bad request with errors for an agent of an owner and occupier when the date is after the end date in welsh" which {
      ...
      lazy val res = submitOwnership(language = Welsh, day = "01", month = "02", year = "2021", userIsAgent = true, relationship = "both", endDate = occupancyEndDate)
  ...
  private def stubsSetup(userIsAgent: Boolean, fromCya: Boolean, relationshipChoice: String = "owner", propertyOccupancy: Option[PropertyOccupancy] = None): StubMapping = {
  ...
  private def submitOwnership(language: Language = English, day: String, month: String, year: String, userIsAgent: Boolean = false, fromCya: Boolean = true, relationship: String, endDate: Option[PropertyOccupancy] = None): WSResponse = {

    stubsSetup(userIsAgent = userIsAgent, fromCya = fromCya, relationshipChoice = relationship, propertyOccupancy = endDate)
