...
class DeclarationControllerConfirmationISpec extends ISpecBase {
  ...
  val weWillProcessText = "We will process your claim to this property as quickly as possible but this may take up to 15 working days."
  val youCanSeeText = "You can see the status of your claim in your properties. Once the claim is approved, the status will update."
  val youCanSeeAgentText = "You can see the status of your claim in your client’s properties. Once the claim is approved, the status will update."
  ...
  val makeANoteTextWelsh = "Gwnewch nodyn o’ch cyfeirnod gan y bydd angen i chi ei ddarparu os byddwch yn cysylltu â ni."
  val whatHappensNextTextWelsh = "Beth sy’n digwydd nesaf"
  val weWillProcessTextWelsh = "Byddwn yn prosesu’ch cais i hawlio’r eiddo hwn cyn gynted â phosibl ond gall hyn gymryd hyd at 15 diwrnod gwaith."
  val youCanSeeTextWelsh = "Gallwch weld statws eich hawliad yn eich eiddo. Unwaith y bydd yr hawliad wedi’i gymeradwyo, bydd y statws yn cael ei ddiweddaru."
  val youCanSeeAgentTextWelsh = "Gallwch weld statws eich cais ar eiddo eich cleient. Unwaith y bydd y cais wedi’i gymeradwyo, bydd y statws yn diweddaru."
  ...
  private def getConfirmationPage(language: Language, userIsAgent: Boolean) = {
    ...
    val res = await(
      ws.url(s"http://localhost:$port/business-rates-property-linking/my-organisation/claim/property-links/confirmation")
