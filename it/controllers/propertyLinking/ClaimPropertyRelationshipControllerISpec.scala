...
class ClaimPropertyRelationshipControllerISpec extends ISpecBase {
  ...
  val ownOrOccupySummaryContentText = "After the Valuation Office Agency have approved your connection, you may want to ask them to split this property to get separate valuations for each part."
  val ownOrOccupySummaryContentTextAgent = "You can still add this property on behalf of your client, as if they owned or occupied the whole property. After we’ve approved your client’s connection to the property, you can ask us to split the property to get separate valuations for each part."
  ...
  val dontOwnOrOccupySummaryContentP1Text = "If you sublet the property to another person or business, select ‘Owner’ and enter the dates of the sublet period."
  val dontOwnOrOccupySummaryContentP1TextAgent = "Your client is considered to be the owner if they sublet the property to another person or business. Enter the date the sublet started."
  val dontOwnOrOccupySummaryContentP2Text = "If you only sublet part of the property, you may want to ask the Valuation Office Agency to split this property to get separate valuations for each part. You can do this after they have approved your connection to the property."
  val dontOwnOrOccupySummaryContentP2TextAgent = "If only part of the property is sublet, you can ask us to split the property to get separate valuations for each part. You can do this after we’ve approved your client’s connection to the property."
  ...
  val ownOrOccupySummaryContentTextWelsh = "Ar ôl i Asiantaeth y Swyddfa Brisio gymeradwyo eich cysylltiad, efallai byddwch yn dymuno eu holi i rannu’r eiddo hwn er mwyn cael prisiadau ar wahân ar gyfer pob rhan."
  val ownOrOccupySummaryContentTextAgentWelsh = "Gallwch barhau i ychwanegu’r eiddo hwn ar ran eich cleient, fel pe baent yn berchen neu’n meddiannu’r eiddo cyfan. Ar ôl i ni gymeradwyo cysylltiad eich cleient â’r eiddo, gallwch ofyn i ni rannu’r eiddo i gael prisiadau ar wahân ar gyfer pob rhan."
  val dontOwnOrOccupySummaryLinkTextWelsh = "Nid fi sy’n berchen ar yr eiddo ond rwy’n ei isosod i rywun arall"
  val dontOwnOrOccupySummaryLinkTextAgentWelsh = "Nid fy nghleient sydd berchen yr eiddo, ond maen nhw’n ei isosod i rywun arall"
  val dontOwnOrOccupySummaryContentP1TextWelsh = "Os ydych yn isosod yr eiddo i berson neu fusnes arall, dewiswch ’Perchennog’ a nodi’r dyddiadau neu’r cyfnod isosod."
  val dontOwnOrOccupySummaryContentP1TextAgentWelsh = "Ystyrir mai eich cleient yw’r perchennog os ydynt yn isosod yr eiddo i berson neu fusnes arall. Nodwch y dyddiad dechreuodd yr isosod."
  val dontOwnOrOccupySummaryContentP2TextWelsh = "Os ydych yn isosod rhan o’r eiddo yn unig, efallai dymunwch holi Asiantaeth y Swyddfa Brisio i rannu’r eiddo er mwyn derbyn prisiadau ar wahân ar gyfer pob rhan. Gallwch wneud hyn wedi iddynt gymeradwyo eich cysylltiad â’r eiddo."
  val dontOwnOrOccupySummaryContentP2TextAgentWelsh = "Os mai dim ond rhan o’r eiddo sy’n cael ei isosod, gallwch ofyn i ni rannu’r eiddo i gael prisiadau ar wahân ar gyfer pob rhan. Gallwch wneud hyn ar ôl i ni gymeradwyo cysylltiad eich cleient â’r eiddo."
  ...
  val ownerAndOccupierLabelLocator = "#main-content > div > div > form > div > fieldset > div > div:nth-child(3) > label"
  ...
  "ClaimPropertyRelationshipController showRelationship displays the correct content in Welsh for an Agent" which {
    ...
    s"has a $dontOwnOrOccupySummaryLinkTextAgent link with correct content in Welsh" in {
      ...
      document.select(dontOwnOrOccupySummaryContentP1Locator).text shouldBe dontOwnOrOccupySummaryContentP1TextAgentWelsh
      document.select(dontOwnOrOccupySummaryContentP2Locator).text shouldBe dontOwnOrOccupySummaryContentP2TextAgentWelsh
    }
  ...
  "ClaimPropertyRelationshipController submitRelationship displays an error in English when the IP doesn't select a radio" which {
    lazy val res = postPropertyRelationshipPage(language = English, userIsAgent = false, selectedRadio = None, fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship displays an error in English when the Agent doesn't select a radio" which {
    lazy val res = postPropertyRelationshipPage(language = English, userIsAgent = true, selectedRadio = None, fromCya = false)
    lazy val document = Jsoup.parse(res.body)
  ...
  "ClaimPropertyRelationshipController submitRelationship displays an error in Welsh when the IP doesn't select a radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = None, fromCya = false)
    lazy val document = Jsoup.parse(res.body)
  ...
  "ClaimPropertyRelationshipController submitRelationship displays an error in Welsh when the Agent doesn't select a radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = None, fromCya = false)
    lazy val document = Jsoup.parse(res.body)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the property ownership page when an IP selects the 'Owner and occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OWNER_OCCUPIER"), fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the property ownership page when an IP selects the 'Owner' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OWNER"), fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the property ownership page when an IP selects the 'Occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OCCUPIER"), fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the property ownership page when an Agent selects the 'Owner and occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OWNER_OCCUPIER"), fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the property ownership page when an Agent selects the 'Owner' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OWNER"), fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the property ownership page when an Agent selects the 'Occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OCCUPIER"), fromCya = false)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the check your answers page when an IP selects the 'Owner and occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OWNER_OCCUPIER"), fromCya = true)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the check your answers page when an IP selects the 'Owner' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OWNER"), fromCya = true)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the check your answers page when an IP selects the 'Occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OCCUPIER"), fromCya = true)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the check your answers page when an Agent selects the 'Owner and occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OWNER_OCCUPIER"), fromCya = true)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the check your answers page when an Agent selects the 'Owner' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OWNER"), fromCya = true)
  ...
  "ClaimPropertyRelationshipController submitRelationship redirects to the check your answers page when an Agent selects the 'Occupier' radio" which {
    lazy val res = postPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OCCUPIER"), fromCya = true)
  ...
  "ClaimPropertyRelationshipController back takes the IP back to the relationship page with a preselected 'Owner and occupier' radio in English" which {
    lazy val document = getBackToPropertyRelationshipPage(language = English, userIsAgent = false, selectedRadio = Some("OWNER_OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the IP back to the relationship page with a preselected 'Occupier' radio in English" which {
    lazy val document = getBackToPropertyRelationshipPage(language = English, userIsAgent = false, selectedRadio = Some("OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the IP back to the relationship page with a preselected 'Owner' radio in English" which {
    lazy val document = getBackToPropertyRelationshipPage(language = English, userIsAgent = false, selectedRadio = Some("OWNER"))
  ...
  "ClaimPropertyRelationshipController back takes the Agent back to the relationship page with a preselected 'Owner and occupier' radio in English" which {
    lazy val document = getBackToPropertyRelationshipPage(language = English, userIsAgent = true, selectedRadio = Some("OWNER_OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the Agent back to the relationship page with a preselected 'Occupier' radio in English" which {
    lazy val document = getBackToPropertyRelationshipPage(language = English, userIsAgent = true, selectedRadio = Some("OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the Agent back to the relationship page with a preselected 'Owner' radio in English" which {
    lazy val document = getBackToPropertyRelationshipPage(language = English, userIsAgent = true, selectedRadio = Some("OWNER"))
  ...
  "ClaimPropertyRelationshipController back takes the IP back to the relationship page with a preselected 'Owner and occupier' radio in Welsh" which {
    lazy val document = getBackToPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OWNER_OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the IP back to the relationship page with a preselected 'Occupier' radio in Welsh" which {
    lazy val document = getBackToPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the IP back to the relationship page with a preselected 'Owner' radio in Welsh" which {
    lazy val document = getBackToPropertyRelationshipPage(language = Welsh, userIsAgent = false, selectedRadio = Some("OWNER"))
  ...
  "ClaimPropertyRelationshipController back takes the Agent back to the relationship page with a preselected 'Owner and occupier' radio in Welsh" which {
    lazy val document = getBackToPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OWNER_OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the Agent back to the relationship page with a preselected 'Occupier' radio in Welsh" which {
    lazy val document = getBackToPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OCCUPIER"))
  ...
  "ClaimPropertyRelationshipController back takes the Agent back to the relationship page with a preselected 'Owner' radio in Welsh" which {
    lazy val document = getBackToPropertyRelationshipPage(language = Welsh, userIsAgent = true, selectedRadio = Some("OWNER"))
  ...
  private def getPropertyRelationshipPage(language: Language, userIsAgent: Boolean) = {
    ...
    val res = await(
      ws.url(s"http://localhost:$port/business-rates-property-linking/my-organisation/claim/property-links/capacity/relationship")
  ...
  private def postPropertyRelationshipPage(language: Language, userIsAgent: Boolean, selectedRadio: Option[String], fromCya: Boolean) = {
  ...
  private def getBackToPropertyRelationshipPage(language: Language, userIsAgent: Boolean, selectedRadio: Option[String]) = {
