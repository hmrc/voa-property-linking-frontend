...
class AppointMultiplePropertiesISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val errorTitleText = "Error: Which of your properties do you want to assign Test Agent to? - Valuation Office Agency - GOV.UK"
  ...
  val errorTitleTextWelsh = "Gwall: Pa un o’ch eiddo yr hoffech ei neilltuo i Test Agent? - Valuation Office Agency - GOV.UK"
  ...
  val assignToOneOrMoreRedirectUrl = "/business-rates-property-linking/my-organisation/appoint/properties?page=1&pageSize=15&agentCode=1234&agentAppointed=BOTH&backLinkUrl=%2Fbusiness-rates-property-linking%2Fmy-organisation%2Fappoint-new-agent%2Fmultiple-properties&fromManageAgentJourney=false"

  "AddAgentController multipleProperties displays the correct content in English" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = English, fromCya = false, cyaPreSelectedRadioButton = None)
  ...
  "AddAgentController multipleProperties displays the correct content in Welsh" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = Welsh, fromCya = false, cyaPreSelectedRadioButton = None)
  ...
  "AddAgentController multipleProperties displays the correct content in English when coming back from the Check Your Answers page with the 'All properties' radio preselected" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = English, fromCya = true, cyaPreSelectedRadioButton = Some("all"))
  ...
  "AddAgentController multipleProperties displays the correct content in English when coming back from the Check Your Answers page with the 'One or more properties' radio preselected" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = English, fromCya = true, cyaPreSelectedRadioButton = Some("choose_from_list"))
  ...
  "AddAgentController multipleProperties displays the correct content in English when coming back from the Check Your Answers page with the 'Do not assign to any properties' radio preselected" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = English, fromCya = true, cyaPreSelectedRadioButton = Some("none"))
  ...
  "AddAgentController multipleProperties displays the correct content in Welsh when coming back from the Check Your Answers page with the 'All properties' radio preselected" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = Welsh, fromCya = true, cyaPreSelectedRadioButton = Some("all"))
  ...
  "AddAgentController multipleProperties displays the correct content in Welsh when coming back from the Check Your Answers page with the 'One or more properties' radio preselected" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = Welsh, fromCya = true, cyaPreSelectedRadioButton = Some("choose_from_list"))
  ...
  "AddAgentController multipleProperties displays the correct content in Welsh when coming back from the Check Your Answers page with the 'Do not assign to any properties' radio preselected" which {
    lazy val document = getAssignToMultiplePropertiesPage(language = Welsh, fromCya = true, cyaPreSelectedRadioButton = Some("none"))
  ...
  private def getAssignToMultiplePropertiesPage(language: Language, fromCya: Boolean, cyaPreSelectedRadioButton: Option[String]) = {
    stubAuth()
  ...
  private def postAssignToMultiplePropertiesPage(language: Language, selectedRadio: Option[String]) = {
    ...
    await(
      ws.url(s"http://localhost:$port/business-rates-property-linking/my-organisation/appoint-new-agent/multiple-properties")
        .withCookies(languageCookie(language), getSessionCookie(testSessionId))
