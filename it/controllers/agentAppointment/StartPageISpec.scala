...
class StartPageISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val p1TextWelsh = "Pan fyddwch yn penodi asiant i’ch cyfrif, bydd yr asiant hwn yn gallu gweithredu ar eich rhan. Mae hyn yn golygu ei fod yn gallu:"
  ...
  val p2TextWelsh = "Gall yr asiant weithredu ar eiddo rydych yn eu neilltuo iddo, ac ar eiddo y mae’n eu hychwanegu at eich cyfrif."
