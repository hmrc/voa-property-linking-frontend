...
class RegisterISpec extends ISpecBase with HtmlComponentHelpers with ListYearsHelpers {
  ...
  val iDontHaveTheseDetailsExpandedSelector = "#main-content > div > div > details:nth-child(7) > div > p"
  val iDontHaveTheseDetailsExpandedHrefSelector = "#main-content > div > div > details:nth-child(7) > div > p > a"
