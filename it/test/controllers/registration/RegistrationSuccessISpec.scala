...
class RegistrationSuccessISpec extends ISpecBase with HtmlComponentHelpers with ListYearsHelpers {
  ...
  val infoProvidedText =
    "Information provided using this service is only for the purposes of checking and, if necessary, challenging and appealing the rating of non-domestic property. Use for any other purpose is a breach of the terms and conditions of service. Unlawful access may be prosecuted under the relevant legislation, including the Computer Misuse Act 1990 or the Fraud Act 2006."
  ...
  val youWillNotTextWelsh =
    "Ni fydd angen i chi fewngofnodi i’r gwasanaeth gwirio a herio – dylech barhau i ddefnyddio eich manylion Porth y Llywodraeth i fewngofnodi."
  val ifAnyoneElseTextWelsh =
    "Os oes unrhyw un arall eisiau cofrestru ar ran y busnes, bydd angen i chi eu hychwanegu i’ch cyfrif Porth y Llywodraeth fel gweinyddwr neu gynorthwyydd yn gyntaf."
