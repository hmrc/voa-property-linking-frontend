...
class RequestDetailedValuationISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  "myOrganisationAlreadyRequestedDetailValuation displays the correct content for viewing a draft valuation - English" which {
  ...
  "myOrganisationAlreadyRequestedDetailValuation displays the correct content for viewing a draft valuation - Welsh" which {
  ...
  private def getPage(language: Language): Document = {
