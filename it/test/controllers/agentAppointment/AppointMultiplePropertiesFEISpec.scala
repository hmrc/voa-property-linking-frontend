...
class AppointMultiplePropertiesFEISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val assignToAllTextWelsh = "Neilltuo i bob eiddo"
  val assignToOneOrMoreTextWelsh = "Neilltuo i un eiddo neu fwy"
  val doNotAssignTextWelsh = "Peidio â neilltuo i unrhyw eiddo"
