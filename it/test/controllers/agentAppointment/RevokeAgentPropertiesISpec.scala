...
class RevokeAgentPropertiesISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val titleTextWelsh = s"O ba eiddo ycych chi am ddad-neilltuo $agentName? - Y Swyddfa Brisio - GOV.UK"
  val errorTitleTextWelsh =
    s"Gwall: O ba eiddo ycych chi am ddad-neilltuo $agentName? - Y Swyddfa Brisio - GOV.UK"
  val backLinkTextWelsh = "Yn ôl"
  val headingTextWelsh = s"O ba eiddo ycych chi am ddad-neilltuo $agentName?"
  ...
  val selectAllTextWelsh = "Dewiswch bopeth"
  val appointedAgentsTextWelsh = "Asiantiaid penodedig"
  val confirmAndUnassignTextWelsh = "Cadarnhau a dad-neilltuo"
  ...
  val noAddressChoiceTextWelsh = "Dewiswch ba eiddo rydych chi am ddad-neilltuo’r asiant hwn oddi wrthynt"
