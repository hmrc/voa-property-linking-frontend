...
class DeclarationControllerShowSubmitISpec extends ISpecBase {
  ...
  val iDeclareText =
    "I declare that the information I have given is correct and complete. The evidence I have uploaded contains proof of my connection to the property for dates that overlap with the period I have stated."
  val iDeclareAgentText =
    "I declare that the information I have given is correct and complete. The evidence I have uploaded contains proof of my client’s connection to the property for dates that overlap with the period I have stated."
  ...
  private def getShowPage(
    ...
    val evidenceType: UploadEvidenceData = evidenceChoice match {
      ...
      case "StampDutyLandTaxForm" =>
        UploadEvidenceData(fileInfo = Some(CompleteFileInfo("Test File", StampDutyLandTaxForm)))
  ...
  val preparedUpload: PreparedUpload =
    PreparedUpload(Reference(FILE_REFERENCE), UploadFormTemplate("http://localhost/upscan", Map()))
