...
class RatingListConfirmedISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val thisAgentTextThree =
    "This agent can act for you on your property valuations on the 2026, 2023, and 2017 rating lists, for properties that you assign to them or they add to your account"
  ...
  "RatingListConfirmedController" should {
    "Show an English confirmed screen with the correct text when the user has chosen three list years and the language is set to English" which {

      lazy val document = getRatingsListConfirmedPage(English, List("2026", "2023", "2017"))
      ...
      s"has text on the screen of '$thisAgentTextThree'" in {
        document.select(thisAgentSelector).text() shouldBe thisAgentTextThree
      }
    ...
    "Show an English confirmed screen with the correct text when the user has chosen two list years and the language is set to English" which {
      ...
      s"has text on the screen of '$thisAgentTextTwo'" in {
        document.select(thisAgentSelector).text() shouldBe thisAgentTextTwo
      }
    ...
    "Show a Welsh confirmed screen with the correct text when the user has chosen three list years and the language is set to Welsh" which {

      lazy val document = getRatingsListConfirmedPage(Welsh, List("2026", "2023", "2017"))
      ...
      s"has text on the screen of '$thisAgentTextThree' in welsh" in {
        document.select(thisAgentSelector).text() shouldBe thisAgentTextThreeWelsh
      }
    ...
    "Show a Welsh confirmed screen with the correct text when the user has chosen two list years and the language is set to Welsh" which {
      ...
      s"has text on the screen of '$thisAgentTextTwo' in welsh" in {
        document.select(thisAgentSelector).text() shouldBe thisAgentTextTwoWelsh
      }
