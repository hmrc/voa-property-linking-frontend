...
class WhichRatingListISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val whichRatingTextWelsh = "Welsh Which rating list do you want this agent to act on for you?"
  val the2023ListTextWelsh = "Welsh 2023 rating list"
  ...
  val the2017ListTextWelsh = "Welsh 2017 rating list"
