...
class OccupancyOfPropertyISpec extends ISpecBase with HtmlComponentHelpers {
  ...
  val errorTitleTextAgent = "Error: Does your client still own or occupy the property? - Valuation Office Agency - GOV.UK"
  ...
  val futureDateOwnerOccupierErrorText = "Date of your last day as owner and occupier of the property must be in the past"
  val futureDateOwnerOccupierErrorAgentText = "Date of your client’s last day as owner and occupier of the property must be in the past"
  ...
  val futureDateOccupierErrorAgentText = "Date of your client’s last day as occupier of the property must be in the past"
  val enterAValidDateErrorText = "Enter a valid date"
  val earlyStartDateOwnerOccupierErrorText = "Date of your last day as owner and occupier of the property must be after 1 April 2017"
  ...
  val titleTextWelshAgent = "Ydy’ch cleient dal i fod yn berchen neu’n meddiannu’r eiddo? - Valuation Office Agency - GOV.UK"
  ...
  val errorTitleTextWelsh = "Gwall: Ydych chi dal i fod yn berchen neu’n meddiannu’r eiddo? - Valuation Office Agency - GOV.UK"
  val errorTitleTextWelshAgent = "Gwall: Ydy’ch cleient dal i fod yn berchen neu’n meddiannu’r eiddo? - Valuation Office Agency - GOV.UK"
  ...
  val futureDateOwnerOccupierErrorTextWelsh = "Rhaid i ddyddiad eich diwrnod olaf fel perchennog a meddiannydd yr eiddo fod yn y gorffennol"
  val futureDateOwnerOccupierErrorAgentTextWelsh = "Rhaid i ddyddiad diwrnod olaf eich cleient fel perchennog a meddiannydd yr eiddo fod yn y gorffennol"
  val futureDateOwnerErrorTextWelsh = "Rhaid i ddyddiad eich diwrnod olaf fel perchennog yr eiddo fod yn y gorffennol"
  val futureDateOwnerErrorAgentTextWelsh = "Rhaid i ddyddiad diwrnod olaf eich cleient fel perchennog yr eiddo fod yn y gorffennol"
  val futureDateOccupierErrorTextWelsh = "Rhaid i ddyddiad eich diwrnod olaf fel meddiannydd yr eiddo fod yn y gorffennol"
  val futureDateOccupierErrorAgentTextWelsh = "Rhaid i ddyddiad diwrnod olaf eich cleient fel meddiannydd yr eiddo fod yn y gorffennol"
  val enterAValidDateErrorTextWelsh = "Nodwch ddyddiad dilys"
  val earlyStartDateOwnerOccupierErrorTextWelsh = "Rhaid i ddyddiad eich diwrnod olaf fel perchennog a meddiannydd yr eiddo fod ar ôl 1 Ebrill 2017"
  val earlyStartDateOwnerErrorTextWelsh = "Rhaid i ddyddiad eich diwrnod olaf fel perchennog yr eiddo fod ar ôl 1 Ebrill 2017"
  val earlyStartDateOccupierErrorTextWelsh = "Rhaid i ddyddiad eich diwrnod olaf fel meddiannydd yr eiddo fod ar ôl 1 Ebrill 2017"
  ...
  "OccupancyOfPropertyController post method" should {
    "Redirect to the choose evidence page if the user chooses yes and has not come from cya" in {
      ...
      res.headers("Location").head shouldBe "/business-rates-property-linking/my-organisation/claim/property-links/evidence"
    ...
    "Return a bad request and show the error page if the user is an owner and occupier and has not chosen a radio button" when {
      ...
      lazy val document: Document = postOccupancyOfPropertyPage(language = English, userIsAgent = false, fromCya = false,
              owner = true, occupier = true, postBody = requestBody)
    ...
    "Return a bad request and show the error page if the user is an owner and has not chosen a radio button" when {
      ...
      lazy val document: Document = postOccupancyOfPropertyPage(language = English, userIsAgent = false, fromCya = false,
        owner = true, occupier = false, postBody = requestBody)
    ...
    "Return a bad request and show the error page if it's the agent of an owner and occupier and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefix + earlyStartDateOwnerOccupierErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefix + earlyStartDateOwnerOccupierErrorAgentText
      }
    ...
    "Return a bad request and show the error page if if it's the agent of an an owner and occupier and has set a future date" when {
      ...
      s"has an error message above the date fields of ${errorPrefix + futureDateOwnerOccupierErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefix + futureDateOwnerOccupierErrorAgentText
      }
    ...
    "Return a Welsh bad request and show the error page if the user is an owner and occupier and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + earlyStartDateOwnerOccupierErrorText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + earlyStartDateOwnerOccupierErrorTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if the user is an owner and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + earlyStartDateOwnerErrorText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + earlyStartDateOwnerErrorTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if the user is an occupier and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + earlyStartDateOccupierErrorText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + earlyStartDateOccupierErrorTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if it's the agent of an owner and occupier and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + earlyStartDateOwnerOccupierErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + earlyStartDateOwnerOccupierErrorAgentTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if it's the agent of an owner and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + earlyStartDateOwnerErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + earlyStartDateOwnerErrorAgentTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if it's the agent of an occupier and has set an early date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + earlyStartDateOccupierErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + earlyStartDateOccupierErrorAgentTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if the user is an owner and occupier and has set a future date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + futureDateOwnerOccupierErrorText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + futureDateOwnerOccupierErrorTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if the user is an occupier and has set a future date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + futureDateOccupierErrorText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + futureDateOccupierErrorTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if if it's the agent of an an owner and occupier and has set a future date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + futureDateOwnerOccupierErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + futureDateOwnerOccupierErrorAgentTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if it's the agent of an an owner and has set a future date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + futureDateOwnerErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + futureDateOwnerErrorAgentTextWelsh
      }
    ...
    "Return a Welsh bad request and show the error page if it's the agent of an an occupier and has set a future date" when {
      ...
      s"has an error message above the date fields of ${errorPrefixWelsh + futureDateOccupierErrorAgentText}" in {
        document.select(aboveDateFieldsErrorSelector).text() shouldBe errorPrefixWelsh + futureDateOccupierErrorAgentTextWelsh
      }
  ...
  private def getOccupancyOfPropertyPage(language: Language, userIsAgent: Boolean, fromCya: Boolean, owner: Boolean,
    ...
    await(
      mockRepository.saveOrUpdate(
        LinkingSession(
          ...
          propertyOccupancy = if (fromCya) Some(
            PropertyOccupancy(stillOccupied = occupier, lastOccupiedDate = None)) else None,
          hasRatesBill = Some(true),
          uploadEvidenceData = UploadEvidenceData(fileInfo = None, attachments = None),
          evidenceType = Some(RatesBillType),
  ...
  private def postOccupancyOfPropertyPage(language: Language, userIsAgent: Boolean, fromCya: Boolean, owner: Boolean,
                                occupier: Boolean, postBody: JsObject): Document = {
