...
object SessionDocument {
  ...
  implicit lazy val ldf = Json.format[LinkDeclaration]
...
case class SessionDocument(claimedProperty: Property, declaration: Option[LinkDeclaration] = None)
...
case class LinkDeclaration(capacity: String, fromDate: DateTime, toDate: DateTime)
