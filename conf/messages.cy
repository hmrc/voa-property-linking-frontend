...
ratingsListConfirmation.multiple.forAllYour.three = Ar gyfer eich prisiadau eiddo ar restrau ardrethu {0}, {1}, a {2}, bydd yr asiant hwn yn gallu:
ratingsListConfirmation.multiple.forAllYour.two = Ar gyfer eich prisiadau eiddo ar restrau ardrethu {0} a {1}, bydd yr asiant hwn yn gallu:
ratingsListConfirmation.single.forAllYour = Ar gyfer eich prisiadau eiddo ar restr ardrethu {0}, bydd yr asiant hwn yn gallu:
ratingsListConfirmation.seeDetailed = gweld gwybodaeth fanwl am eiddo
ratingsListConfirmation.seeCheck = gweld gohebiaeth achosion Gwirio a Herio megis negeseuon ac e-byst
ratingsListConfirmation.sendCheck = anfon achosion Gwirio a Herio
...
label.interestedStartDate=Pryd ddaethoch chi’n berchennog neu’n feddiannydd yr eiddo?
label.interestedStartDate.client=Pryd ddaeth eich cleient yn berchennog neu’n feddiannydd yr eiddo?
interestedStartDate.true=Ar neu cyn {0}
interestedStartDate.false=Ar ôl {0}
label.stillOccupied.owner=Dewiswch os ydych dal yn berchennog yr eiddo
label.stillOccupied.client.owner=Dewiswch os yw’ch cleient dal i fod yn berchennog yr eiddo
label.stillOccupied.occupier=Dewiswch os ydych dal i fod yn feddiannydd yr eiddo
label.stillOccupied.client.occupier=Dewiswch os yw eich cleient dal i fod yn feddiannydd yr eiddo
label.stillOccupied.ownerAndOccupier=Dewiswch os taw chi yw perchennog a meddiannydd yr eiddo o hyd
label.stillOccupied.client.ownerAndOccupier=Dewiswch os taw eich cleient yw perchennog a meddiannydd yr eiddo o hyd
label.lastOccupiedDate.owner=Dyddiad eich diwrnod olaf fel perchennog yr eiddo
label.lastOccupiedDate.client.owner=Dyddiad diwrnod olaf eich cleient fel perchennog yr eiddo
label.lastOccupiedDate.occupier=Dyddiad eich diwrnod olaf fel meddiannydd yr eiddo
label.lastOccupiedDate.client.occupier=Dyddiad diwrnod olaf eich cleient fel meddiannydd yr eiddo
label.lastOccupiedDate.ownerAndOccupier=Dyddiad eich diwrnod olaf fel perchennog a meddiannydd yr eiddo
label.lastOccupiedDate.client.ownerAndOccupier=Dyddiad diwrnod olaf eich cleient fel perchennog a meddiannydd yr eiddo
...
label.interestedStartDate=Ar ba ddyddiad ddaethoch chi’n berchennog neu’r meddiannydd?
label.interestedStartDate.client=Ar ba ddyddiad y daeth eich cleient yn berchennog neu’n feddiannydd?
...
error.date.mustBeAfterStartDate.client=Rhaid i ddyddiad diwrnod olaf eich cleient fel {0} yr eiddo fod ar ôl {1}
error.date.mustBeAfterStartDate=Rhaid i ddyddiad eich diwrnod olaf fel {0} yr eiddo fod ar ôl {1}
...
label.interestedStartDate.day=Ar ba ddyddiad ddaethoch chi’n berchennog neu’n feddiannydd? - Diwrnod
label.interestedStartDate.day.client=Ar ba ddyddiad y daeth eich cleient yn berchennog neu’n feddiannydd? - Diwrnod
label.interestedStartDate.month=Ar ba ddyddiad ddaethoch chi’n berchennog neu’r meddiannydd? - Mis
label.interestedStartDate.month.client=Ar ba ddyddiad y daeth eich cleient yn berchennog neu’n feddiannydd? - Mis
label.interestedStartDate.year=Ar ba ddyddiad ddaethoch chi’n berchennog neu’r meddiannydd? - Blwyddyn
label.interestedStartDate.year.client=Ar ba ddyddiad y daeth eich cleient yn berchennog neu’n feddiannydd? - Blwyddyn
...
available.requestvaluation.startCheckTab.new.guidance.link=Mae’r cyfarwyddyd hwn yn eich helpu i gwblhau eich gwiriad
