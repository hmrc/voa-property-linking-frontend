...
class BackendConnector @Inject()(http: WSHttp, conf: ServicesConfig) (implicit ec: ExecutionContext) {

  val groupAccountsUrl = s"${conf.baseUrl("external-business-rates-data-platform")}/customer-management-api/organisation"
